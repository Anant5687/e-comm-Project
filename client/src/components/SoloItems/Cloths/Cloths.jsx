...
const Cloths = () => {
  ...
  const { apidata, loading, error } = useApiData("http://localhost:8989/product/filter/Cloth")
            ...
            <Card sx={{ maxWidth: 345 }} style={{ marginTop: "4%", marginLeft: "5%" }}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam tempore quidem provide,
                </Typography>
              </CardContent>
              <CardActions>
