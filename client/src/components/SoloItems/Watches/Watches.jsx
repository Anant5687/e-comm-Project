...
const Watches = () => {
    ...
    const { loading, error, apidata } = useApiData("http://localhost:8989/product/filter/Watch")
                                ...
                                <Card sx={{ maxWidth: 345 }} style={{ marginTop: "4%", marginLeft: "5%" }}>
                                    ...
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" color="text.secondary">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa aperiam, eos molestias temporibus aliquam
                                        </Typography>
                                    </CardContent>
                                    <CardActions>
