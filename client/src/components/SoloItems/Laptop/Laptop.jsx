...
const Laptop = () => {
  ...
  const { error, loading, apidata } = useApiData("http://localhost:8989/product/filter/Laptop")
              ...
              <Card sx={{ maxWidth: 345 }} style={{ marginTop: "4%", marginLeft: "5%" }}>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa nisi, dignissimos praesent.
                  </Typography>
                </CardContent>
                <CardActions>
