...
const Mobiles = () => {
  const {  apidata } = useApiData("http://localhost:8989/product/filter/Mobile")
  const selector = useSelector(state => state.userInfo.userInfo)
  console.log(selector._id)
              ...
              <Card sx={{ maxWidth: 345 }} style={{ marginTop: "4%", marginLeft: "5%" }}>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quisquam, sed dolor. Laborum dolorum repudiandae
                  </Typography>
                </CardContent>
                <CardActions>
